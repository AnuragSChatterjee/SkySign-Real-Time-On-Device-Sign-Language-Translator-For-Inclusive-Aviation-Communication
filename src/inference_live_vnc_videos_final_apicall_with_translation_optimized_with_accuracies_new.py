...
CORRECTED_TRANSLATIONS = {
    ...
    "Yes": {"es": "Sí", "hi": "हाँ", "fr": "Oui", "zh-CN": "是", "ar": "नعم"},
...
def main():
    ...
    # Tracker for end-of-session accuracies
    ...
    # Check IP Webcam app on your phone for current IP
    cap = cv2.VideoCapture("http://192.168.1.239:8080/video")
    history = deque(maxlen=5)

    print("🚀 SkySign AI Active. Access Dashboard at http://192.168.1.239:5000")
    ...
    try:
        while cap.isOpened():
            ...
            if results.multi_hand_landmarks:
                ...
                # Dequantize output to get confidence
